...
def gui():
    ...
    logo = guizero.Picture(app, image="$HOME/pi-apps/icons/logo-simple.png", width=100, height=100, grid=[1, 1])
    logo_text = guizero.Picture(app, image="$HOME/pi-apps/icons/vector/logo-ext-text.svg", grid=[2, 1])
    app.display()
start()
gui()
